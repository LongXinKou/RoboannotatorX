...
from roboannotatorx.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(
        ...
        if data_path.endswith('.json'):
            ...
            rank0_print(f"Loaded {len(list_data_dict)} samples from {data_path}")
        elif data_path.endswith('.yaml'):
            yaml_data = yaml.safe_load(data_path)
