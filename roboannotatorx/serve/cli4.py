...
def main(args):
    ...
    while True:
        try:
            ...
            if cnt==1:
                break
            file_path='/home/ubuntu/Video-LLaVA/prompt/two/caption.json'
            output_path = '/home/ubuntu/LLaMA-VID/for_test_lohoravens/caption/random_prompt_lohoravens.txt'
            
            with open(file_path,'r',encoding='utf-8')as file1:
                data=json.load(file1)
                
            random_caption=random.choice(data['caption'])
            
            inp=random_caption
            
            with open(output_path, 'a', encoding='utf-8') as file2:
                file2.write(inp+"\n")
                
            
            print(f"Selected caption: {inp}")
            cnt = cnt +1
            #------------------------------#
        except EOFError:
            inp = ""
        ...
        with open('/home/ubuntu/LLaMA-VID/for_test_lohoravens/caption/output_lohoravens.txt', 'a', encoding='utf-8') as file3:
            file3.write(target)
        #---------#
