...
from roboannotatorx.model.builder import load_pretrained_model,load_lora_model,load_roboannotator
...
def main(args):
    ...
    tokenizer, model, image_processor, context_len = load_lora_model(args.model_path, args.model_base, model_name, args.load_8bit, args.load_4bit)
    ...
    #---------#
    cnt=0
    json_file_path = '/data/ubuntu/lohoravens_error/test/llamavid_output/output_llamavid12.json'
