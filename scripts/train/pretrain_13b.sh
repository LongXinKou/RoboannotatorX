...
deepspeed roboannotatex/train/train_mem_robo.py \
    ...
    --image_processor ./roboannotatex/processor/clip-patch14-336 \
    ...
    --bf16 True \
    --output_dir ./work_dirs/roboannotatex/v1/roboannotatex-13b-4x-grid8-interval32-pretrain-image-epoch-1 \
    --num_train_epochs 1 \
