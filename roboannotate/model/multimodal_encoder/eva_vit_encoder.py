"""
# Adapted from https://github.com/dvlab-research/LLaMA-VID/tree/main
"""
import math
...
class EVAVisionTowerLavis(nn.Module):
    def __init__(self, vision_tower, image_processor, args, use_checkpoint=False, drop_path_rate=0.0, delay_load=False,
                 dtype=torch.float32):
        super().__init__()
